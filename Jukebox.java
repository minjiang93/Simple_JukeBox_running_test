...
public class Jukebox {
   ...
   public static void main(String[] args){
      Song song1=new Song("Storyteller", "XiaoHun Alex", 
              "Storyteller", "Shuoshuren.mp3", "Mp3", 180);
      Song song2=new Song("Uncommon words", "Alex", 
              "Uncommon words", "Shenpizi.mp3", "Mp3", 216);
      Song song3=new Song("Storyteller", "XiaoHun Alex", 
              "Storyteller", "D:/eclipse workspace/jukeBox/Shuoshuren.mp3", "Mp3", 180);
